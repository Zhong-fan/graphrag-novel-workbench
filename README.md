...
| 写作模型 | `GRAPH_MVP_WRITER_MODEL` |
| 工具模型 | `GRAPH_MVP_UTILITY_MODEL` |
...
GRAPH_MVP_WRITER_MODEL=gpt-4.1
GRAPH_MVP_UTILITY_MODEL=gpt-4.1-mini
GRAPH_MVP_EMBEDDING_BASE_URL=https://api.openai.com/v1
GRAPH_MVP_EMBEDDING_MODEL=text-embedding-3-small
