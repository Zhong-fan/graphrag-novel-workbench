...
from .api_routes_graphrag_generation import register_graphrag_generation_routes
...
def register_routes(
    ...
    *,
    ...
    register_graphrag_generation_routes(router, settings=settings, run_index_job=run_index_job)
