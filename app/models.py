...
class BatchGenerationChapterTask(Base, TimestampMixin):
    ...
    invalidated_by_chapter_no: Mapped[int | None] = mapped_column(Integer, nullable=True)
    invalidated_by_draft_version_id: Mapped[int | None] = mapped_column(ForeignKey("draft_versions.id"), nullable=True)
