...
def _batch_chapter_task_out(task: BatchGenerationChapterTask) -> BatchGenerationChapterTaskOut:
    return BatchGenerationChapterTaskOut(
        ...
        invalidation_reason=task.invalidation_reason,
        invalidated_by_chapter_no=task.invalidated_by_chapter_no,
        invalidated_by_draft_version_id=task.invalidated_by_draft_version_id,
